...
<div class="container border border-dark rounded-lg" style="background: rgba(220,220,220,0.6); padding:1em;">
    ...
    <div class="container">
        ...
        <form method="post" name="user" action="{{ url()->current() }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            {!! csrf_field() !!}
            <div class="row border border-primary rounded-lg border-3 p-10" style="margin-top:3em; padding: 2em;">
                <div class="col-lg-12">
            ...
            <div class="row border border-primary rounded-lg border-3" style="margin-top:1em; padding:1.5em; margin-bottom: 1em;">
                <div class="col-2">
                    <h4>Member Info</h4>
                </div>
                <div class="input-group mb-6">
                ...
                @if( $user->user_info->image )
                    ...
                    <div class="col-6 mt-2">Image help: use an image ideally no larger than 150x150px</div>
                    <div class="input-group mb-6">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
