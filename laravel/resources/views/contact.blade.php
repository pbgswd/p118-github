...
@section('content')
    <div class="container">
        <div class="row border border-dark rounded-lg p-lg-5" style="background: rgba(220,220,220,0.8);">
            ...
            <div class="col-md-6 content">
                <h3><a href="https://goo.gl/maps/h1ftiTc6NoBXj5D1A" target="_blank" title="IATSE Local 118 Office">
                        <i class="fas fa-map-marked-alt"></i> Maps</a></h3>
            ...
            @else
                <div class="col-md-12 mt-5 content">
                    <h3><a href="tel:6042597365"><i class="fas fa-phone-square"></i> Local 118 Dispatch:
                            604-259-7365</a></h3>
                </div>
            @endguest
            <div class="col-md-12 mt-5 content">
