    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <picture>
                    <source srcset="/storage/public/ePnuaj0PPPTBGKXoXoXk3NoIpzjRcMlMkAzndrRd.jpg" media="(min-width: 1400px)">
                    <source srcset="/storage/public/ePnuaj0PPPTBGKXoXoXk3NoIpzjRcMlMkAzndrRd.jpg" media="(min-width: 577px)">
                    <img src="/storage/public/ePnuaj0PPPTBGKXoXoXk3NoIpzjRcMlMkAzndrRd.jpg" class="d-block img-fluid">
                </picture>
                <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label=" :  " preserveAspectRatio="xMidYMid slice" focusable="false"><title> </title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"> </text></svg>
