<div class="row border border-dark rounded my-3 py-1" style="background: rgba(220,220,220,0.8);">
    <div class="col col-md-3 pt-2">
        <div class="col-12 border border-dark rounded mb-2 text-center">
            <h3>
                Hi {{$data['user']->name}}
            </h3>
        ...
        @hasanyrole(['super-admin|office|writer|committee'])
            <div class="col-12 border border-dark rounded mb-2 bg-secondary font-weight-bold p-1">
        ...
        @foreach ($data['topics'] as $t)
            <div class="col-12 border border-dark rounded pt-1 mb-2 p-1">
                <h5>
    ...
    <div class="col col-md-9 pt-2">
        <div class="col col-12 border border-dark rounded p-2 mb-2 bg-dark">
            <h3>
                <a class="text-white text-bold" href="{{route('features')}}">
                    Feature News
                </a>
            </h3>
        </div>
        ...
        @empty
        @endforelse
        <div class="col-12 border border-dark rounded bg-secondary pt-2 px-2 mb-2">
            <h4>
        ...
        <div class="row mb-2">
            @foreach ($data['posts'] as $post)
                <div class="col-12 col-md-6 pt-1 pb-1">
                    <div class="border border-dark rounded w-100 h-100 p-2">
                        <h6>
                            <i>
        ...
        <div class="col col-12 border border-dark rounded bg-secondary pt-2 px-2 mb-2">
            <h4>
